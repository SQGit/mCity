 ...
 */
public class MAuto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lnr_back_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(MAuto.this,Dashboard.class);
                startActivity(i);
                finish();
            }
        });
        ...
        img_settings_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PopupMenu popup = new PopupMenu(MAuto.this, img_settings_icon);
    ...
    private void exitIcon() {
        ...
        LayoutInflater layoutInflater = LayoutInflater.from(MAuto.this);
        View promptView = layoutInflater.inflate(R.layout.exitdialog, null);
        final AlertDialog alertD = new AlertDialog.Builder(MAuto.this).create();
        ...
        yes.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                SharedPreferences shared = PreferenceManager.getDefaultSharedPreferences(MAuto.this);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new ViewStands(), "VIEW AUTOSTANDS");
        adapter.addFrag(new PriceRates(), "PRICE & RATES");
