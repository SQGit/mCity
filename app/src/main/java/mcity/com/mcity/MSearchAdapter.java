...
public class MSearchAdapter extends BaseAdapter {
    ...
    Bitmap b;
    HashMap<String, String> resultp_garage11 = new HashMap<String, String>();
    ArrayList<String> loading ;
    String str_owner_number,str_owner_mail,str_owner_name,enable_status;
    private static final int MY_PERMISSIONS_REQUEST_CALL_PHONE = 1;


    public MSearchAdapter(Context context, ArrayList<HashMap<String, String>> arraylist) {
    ...
    public View getView(final int position, View view, ViewGroup viewGroup) {
        ...
        View itemView = inflater.inflate(R.layout.mgarage_history_adapter, viewGroup, false);
        resultp_garage11 = data.get(position);

        Log.e("tag","11111"+resultp_garage11);
        loading = new ArrayList<>();

        img1 = resultp_garage11.get("path0");
        img2 = resultp_garage11.get("path1");
        img3 = resultp_garage11.get("path2");
        img4 = resultp_garage11.get("path3");
        ...
        str_model=resultp_garage11.get("field1");
        str_color=resultp_garage11.get("field2");
        str_km=resultp_garage11.get("field4");
        Log.e("tag","value"+resultp_garage11.get("field1")+resultp_garage11.get("field2")+resultp_garage11.get("field4"));
        ...
        if(str_model.equals("not specified")&&str_color.equals("not specified")&&str_km.equals("not specified"))
        {
            ...
            txt_color.setText(resultp_garage11.get("field2"));
            txt_model.setText(resultp_garage11.get("field1"));
            txt_category.setText(resultp_garage11.get("category"));
            txt_price.setText(resultp_garage11.get("price"));
            description.setText(resultp_garage11.get("description"));
            str_owner_number=resultp_garage11.get("mobileno");
            str_owner_name=resultp_garage11.get("username");
            str_owner_mail=resultp_garage11.get("email");
            enable_status=resultp_garage11.get("phone");
        }
        else
        {
        ...
        Picasso.with(context)
                .load(resultp_garage11.get("path0"))
                .into(loadimage);
        Log.e("tag","image_checking"+resultp_garage11.get("path0"));
        ...
        txt_send_mail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               /* Intent emailIntent = new Intent(Intent.ACTION_SENDTO, Uri.fromParts(
                        "mailto", "gunapandian06@gmail.com.", null));*/
        ...
        loadimage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for(int i =0;i<4;i++){
                    if(resultp_garage11.get("path"+i)!= null){
                        loading.add(resultp_garage11.get("path"+i));
                    }
                }
